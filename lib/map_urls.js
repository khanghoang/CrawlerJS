...
CrawlerJS = function(font,config){
  limiter = new RateLimiter(font.limiter, font.interval),
  font.type = 'get',
  font.getAttributes = [],
  ...
  if(typeof font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']] !== 'undefined'){
    if(font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['name'] == 'numbers'){
      ...
      for(i=font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['init']; i<=font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['size']; i=i+font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['diff']){
        ...
        count++;
        if(count == limiter){
          font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['init'] = i+font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['diff'];
          setimeOut(function(){getEntry(fontTemp,url,config)}, font.interval);
          return;
        }else{
      ...
      for(var i in font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['letters']){
      ...
      for(var i in font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['words']){
