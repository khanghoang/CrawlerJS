  ...
  if(typeof font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']] !== 'undefined'){
    for(var c = font[font['type']+'Attributes'].length-1; c>=0; c--){
      if(c == font[font['type']+'Attributes'].length-1){
        ...
        font[font['type']+'Attributes'][c]['interval'] = font[font['type']+'Attributes'][c+1]['interval']*font[font['type']+'Attributes'][c+1]['total'];
      }
    }
    ...
    if(font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['name'] == 'csv'){
      ...
      var i = setInterval(function(){
        ...
        if(font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['init'] > font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['size']){
            clearInterval(i);
        }
      ...
      var i = setInterval(function(){
        ...
        fontTemp[font['type']] = url[font['type']];
        getEntry(fontTemp,url,config);
        if(font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['init'] > font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['total']){
            clearInterval(i);
        }
      }, font[font['type']+'Attributes'][font[font['type']+'CurrentEntry']]['interval']);
    }
