...
var getResult = function(font,url,data,streamFile){
  for(attr in font[font['type']+'Attributes']){
    if(font[font['type']+'Attributes'][attr]['name'] == 'mongodb'){
      font[font['type']+'Attributes'][attr]['collection'].update({cjs:_id},{$set:{cjsStatus:null}},{upsert:true,safe:false});
    }
  }
